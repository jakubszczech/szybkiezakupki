...
import com.example.szybkiezakupki.databinding.FragmentSignup2Binding
...
class Signup2Fragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.textViewSignIn.setOnClickListener {
            navController.navigate(R.id.action_signup2Fragment_to_signinFragment)
        }
    ...
    private fun registerUser(email: String, pass: String) {
        mAuth.createUserWithEmailAndPassword(email, pass).addOnCompleteListener {
            if (it.isSuccessful)
                navController.navigate(R.id.action_signup2Fragment_to_homeFragment)
            else
